...
PARSE		=	get_next_line.c get_next_line_utils.c parsing.c parsing_utils.c init_parsing.c check_parsing1.c check_parsing2.c check_parsing3.c lst_utils.c lst_utils2.c matrice.c matrice2.c matrice_utils.c flood_fill.c flood_fill2.c check_map.c errors_parsing.c
